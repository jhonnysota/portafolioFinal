  ...
  const data = [
    {
      ...
      site: 'Lima, Perú',
      description: 'desarrollo un sistema erp modulo de reporte lenguaje de programacion javascrip utilizando la libreria ReactJS, tambien manejo consultas en la base de datos y creacion de API'
    },
    {
      ...
      site: 'Lima, Perú',
      description: 'Desarrollando la pagina principal de la empresa ralitech, utilizando javascript, Html5, boostraps4, css3, php. tarde un mes en desarrollar la pagina web.'
    }
  ]
  ...
  return (
    <div className='body-experiency'>
      <div className='card-exp'>
        {
          data.map((item) => {
            return (<div className='info-experiency'>
              <div >
