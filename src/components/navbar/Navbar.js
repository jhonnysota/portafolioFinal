          ...
          {widthPage >= 930 &&
            <ul className="gx-nav-ul">
              <li className={"gx-nav-li"}>
                <h4 id="home" className="gx-menu-item" onClick={handleInitial}  > <i className="fas fa-home" style={{ marginRight: '10px' }}></i>Home</h4>
              </li>
              <li className="gx-nav-li">
                <h4 id="about" className="gx-menu-item" onClick={() => handlePosition('.about-container')} ><i className="fas fa-address-card" style={{ marginRight: '10px' }}></i>About</h4>
              </li>
              <li className="gx-nav-li">
      ...
      {widthPage <= 930 &&
        <Menu>
          <div>
            <ul className="nav-ul">
              <li className="nav-li">
                <h1 id="home" className="menu-item" onClick={handleInitial}  > <i className="fas fa-home" style={{ marginRight: '20px' }}></i>Home</h1>
              </li>
              <li className="nav-li">
                <h1 id="about" className="menu-item" onClick={() => handlePosition('.about-container')} ><i className="fas fa-address-card" style={{ marginRight: '20px' }}></i>About</h1>
              </li>
              <li className="nav-li">
              ...
              <li className="nav-li">
                <h1 className="menu-item" onClick={handleEnd}><i className="fas fa-camera" style={{ marginRight: '20px' }}></i>Contactame</h1>
              </li>
            </ul>
          </div>
